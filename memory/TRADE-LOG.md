...
### 2026-08-13 BUY PLTR — open
- Side: buy
- Shares: 14
- Entry price: $173.70 (actual fill $173.703571; cost basis $2,431.85)
- Stop level: $153.08 (12% trailing GTC, id c89fba0d, hwm $173.95); -8% hard-cut reference $159.81
- Target: $215.39 (+24%, 3:1 R/R on 8% risk)
- Catalyst: Blowout Q2 (reported 8/04) drove a ~+30% gap and a breakout to an all-time high $179.59 on 8/10; documented in today's research log.
- Thesis: Breakout to ATH $179.59 (8/10) on 2.3–4x the 20-day avg volume, then a healthy 4.7% pullback to $171 (8/12) on declining, below-average volume (sellers drying up) that held the $172 breakout shelf / 8-day EMA. A benign July PPI print (8/13, 8:30 ET) removed the event risk that kept this primed rather than bought in pre-market; PLTR resumed higher off support (3.4% pullback, in the 3–8% band) at the open, confirming the entry. Technology is the leading momentum sector.
- Sector: Technology
- Earnings next: ~early Nov 2026 (reported 8/04; well outside the 10-day window)
- Time stop: 2026-09-04 (15 trading days from 8/13)

**Execution:** Primed at today's 6 AM CT pre-market (14 sh, conditional on benign PPI + PLTR holding ≥~$168 + gate PASS), executed at market open once all three conditions were met. Market buy 14 sh (order 6c6e7ef3) filled @ $173.70; 12% trailing-stop GTC (order c89fba0d, trail 12%, stop $153.08, hwm $173.95) placed immediately after fill — no PDT rejection. Buy_gate: GATE PASS on all 11 checks (regime SPY 776.13 > SMA20 754.42; positions 1→2; tech 0→1; trades 0→1/3; cost $2,428 vs cash $96,914; PDT 0; earnings none-in-window; catalyst yes; c9 breakout 179.59; c10 volume 3.19M vs 2.03M threshold; is-stock; shadow c12 pullback 3.4%). Trades this week now 1/3.
